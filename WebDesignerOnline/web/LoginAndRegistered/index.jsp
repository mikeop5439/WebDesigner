...
<html>
	<head>
		<title>Home</title>
		<link href="${pageContext.request.contextPath}/LoginAndRegistered/css/bootstrap.css" rel='stylesheet' type='text/css' />
		<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
		<script src="${pageContext.request.contextPath}/LoginAndRegistered/js/jquery.min.js"></script>
		 <!-- Custom Theme files -->
		<link href="${pageContext.request.contextPath}/LoginAndRegistered/css/style.css" rel='stylesheet' type='text/css' />
   		 <!-- Custom Theme files -->
   		  <!---- start-smoth-scrolling---->
		<script type="text/javascript" src="${pageContext.request.contextPath}/LoginAndRegistered/js/move-top.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/LoginAndRegistered/js/easing.js"></script>
	...
	<body>
		<!-- container -->
			...
			<!---- video ---->
				<!---pop-up-box---->
					<script type="text/javascript" src="${pageContext.request.contextPath}/LoginAndRegistered/js/modernizr.custom.min.js"></script>
					<link href="${pageContext.request.contextPath}/LoginAndRegistered/css/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>
					<script src="${pageContext.request.contextPath}/LoginAndRegistered/js/jquery.magnific-popup.js" type="text/javascript"></script>
					<!---//pop-up-box---->
						       ...
						       <div id="owl-demo" class="owl-carousel text-center">
					                <div class="item">
					                 ...
					                 <div class="item">
					                	<div class="portfolio-grid">
											<div class="portfolio-grid-pic">
												<img src="images/port-pic2.jpg" title="name" />
											</div>
											<div class="portfolio-grid-caption text-center">
												<h4>Branding</h4>
												<h5>Metalbrand</h5>
					                 ...
					                 <div class="item">
					                	<div class="portfolio-grid">
											<div class="portfolio-grid-pic">
												<img src="images/port-pic3.jpg" title="name" />
											</div>
											<div class="portfolio-grid-caption text-center">
												<h4>Branding</h4>
												<h5>Metalbrand</h5>
					                 ...
					                 <div class="item">
					                	<div class="portfolio-grid">
											<div class="portfolio-grid-pic">
												<img src="images/port-pic5.jpg" title="name" />
											</div>
											<div class="portfolio-grid-caption text-center">
												<h4>Branding</h4>
												<h5>Metalbrand</h5>
					                 ...
					                 <div class="item">
					                	<div class="portfolio-grid">
											<div class="portfolio-grid-pic">
												<img src="images/port-pic4.jpg" title="name" />
											</div>
											<div class="portfolio-grid-caption text-center">
												<h4>Branding</h4>
												<h5>Metalbrand</h5>
			...
			<div class="clients">
				<div class="container">
					...
					<div class="client-list text-center">
						<ul>
							<li><a href="#"><img src="${pageContext.request.contextPath}/LoginAndRegistered/images/c-logo.png" title="adidas" /></a></li>
							<li><a href="#"><img src="${pageContext.request.contextPath}/LoginAndRegistered/images/c-logo1.png" title="google" /></a></li>
							<li><a href="#"><img src="${pageContext.request.contextPath}/LoginAndRegistered/images/c-logo2.png" title="samsung" /></a></li>
							<li><a href="#"><img src="${pageContext.request.contextPath}/LoginAndRegistered/images/c-logo3.png" title="microsoft" /></a></li>
						</ul>
					</div>
					<!-- /client-list -->
				</div>
					...
					<div class="about-grids">
						<div class="col-md-3 about-grid text-center">
							<div class="about-grid-info">
								<img src="images/about-pic1.png" title="name" />
								<h4>Mike</h4>
						...
						<div class="col-md-3 about-grid text-center">
							<div class="about-grid-info">
								<img src="images/about-pic2.png" title="name" />
								<h4>Taylor</h4>
						...
						<div class="col-md-3 about-grid text-center">
							<div class="about-grid-info">
								<img src="images/about-pic3.png" title="name" />
								<h4>James</h4>
